...
public final class MoneseAccountPayload extends AccountPayload<FiatPaymentMethod>
    ...
    public static MoneseAccountPayload fromProto(bisq.account.protobuf.AccountPayload proto) {
        var payload = proto.getMoneseAccountPayload();
    ...
    public FiatPaymentMethod getPaymentMethod() {
        return FiatPaymentMethod.fromPaymentRail(FiatPaymentRail.MONESE);
    }
